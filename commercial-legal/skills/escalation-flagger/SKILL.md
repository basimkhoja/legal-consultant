...
description: >
  ...
  `${LEGAL_CONSULTANT_HOME:-~/.legal-consultant}/commercial-legal/CLAUDE.md`, and draft the ask. Use when the user
...
- `government-tenders-procurement-law.md` — the applicable procurement rows by matter date (the file's header says which law applies: the 2019 law up to 2027-01-01, the 1448H law from its in-force date; cite every article as "1448H Art. N" or "2019 Art. N"): the delay-penalty cap row (1448H Art. 70 / 2019 Art. 72), the disputes and arbitration row (1448H Art. 94 / 2019 Art. 92), the assignment and subcontracting rows (1448H Arts. 68-69 / 2019 Arts. 70-71), the ban-list rows (Art. 13(1)(d) in both laws; 1448H Art. 87 / 2019 Art. 88).
