...
- `government-tenders-procurement-law.md` — Step 1 counterparty type, when the counterparty is a government entity: Arts. 1, 10, 11, 93 (who is bound), Arts. 55, 91 (form of contract), Arts. 61-63 (performance bond), Art. 69 (variation limits), Arts. 70-71 (assignment and subcontracting consents), Art. 72 (delay-penalty cap), Art. 74 (extension and penalty relief), Arts. 76-78 (termination), Arts. 86-87 (grievance route), Art. 92 (disputes, arbitration).
...
17. **Government counterparty** → `government-tenders-procurement-law.md` when the Orient table says the counterparty is a government entity: the government's terms are largely non-negotiable (Arts. 55, 91); check delay penalties against the Art. 72 caps, extension grounds (Art. 74), performance bond (Arts. 61-63), variation limits (Art. 69), assignment and subcontracting consents (Arts. 70-71), termination and bond forfeiture (Arts. 76-78), the grievance route and its time limits (Arts. 86-87), and forum (Art. 92: administrative court, arbitration only within that article). If the user is a subcontractor to a government prime contractor, check the subcontract for back-to-back terms. Anything that depends on the Regulations (payment timing, advance-payment cap, arbitration threshold) is not in the file: say so and stop that finding.
...
- For a populated non-`usa` code, the jurisdiction-specific triggers the files name for `escalation-flagger` (for `ksa`: a government contract with delay penalties above the `government-tenders-procurement-law.md` Art. 72 caps or a foreign-seated arbitration clause, Art. 92; an interest clause, `civil-transactions-law.md` Arts. 178, 385; a mandatory-rule conflict under Arts. 96, 97, 173, 179, 305; an unregistered agency or distribution structure, `commercial-agencies-law.md`)
...
**Reviewed:** [date — Gregorian; add the Hijri date when the manifest calendar is Hijri]
