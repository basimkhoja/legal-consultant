...
- `references/jurisdictions/<code>/government-tenders-procurement-law.md` — government contracts (Step 1 overlays; Step 1.5). For `ksa`: the applicable procurement rows by matter date (the file's header says which law applies): assignment consent (1448H Art. 68: the entity's written consent / 2019 Art. 70: entity plus Ministry), subcontracting (1448H Art. 69 / 2019 Art. 71), the change-of-control note (`[model knowledge — verify]`), Art. 1 (scope; state-owned companies).
...
|---|---|---|---|---|---|---|---|
| 3.X(a)(1) | [name] | [ksa] | Yes — CoC §12.2 / statutory default [civil-transactions-law.md Art. 255, tag] | [e.g. GTPL assignment consent, 1448H Art. 68 / 2019 Art. 70 by matter date / none] | Requested | [name] | [date] |
