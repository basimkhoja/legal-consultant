...
| Government contracts | `government-tenders-procurement-law.md` Art. 70 (assignment consent: entity plus Ministry), Art. 76(1)(ب) (mandatory-termination trigger on a bankruptcy application), Art. 61 (bond replacement), Etimad classification transfer, ban-list check (Arts. 13(1)(د), 88) | Consents as CPs; bond and Etimad items as deliverables; whether a change of control is treated as assignment is `[model knowledge — verify]` |
