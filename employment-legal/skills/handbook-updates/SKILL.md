...
description: >
  Diff a proposed handbook or work-regulations change against the current
  version, flag ripple effects, jurisdiction-supplement impacts and any
  regulatory re-approval step. Use when user says "update the handbook",
  "add this to the handbook", "handbook change", or has a policy ready for
  insertion.
---
