...
**Primary jurisdiction:** `ksa`
**Footprint (other jurisdictions this practice operates in):** none
**Authoritative language of the primary jurisdiction:** Arabic
...
**Jurisdiction playbook defaults accepted:** all rows of `references/jurisdictions/ksa/playbook-defaults.md` accepted as written
...
**Primary jurisdiction and sub-jurisdictions with employees:** ksa
**Other countries with employees:** none
**Headcount by nationality:** 70 Saudi nationals, 110 non-Saudi
**Nationalisation-quota band:** Low Green (establishment, IT activity) as of 2026-08-01 (synthetic)
...
**Statutory end-of-service entitlement:** per `references/jurisdictions/ksa/labor-law.md`; the skill computes it
